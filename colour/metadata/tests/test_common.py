...
class TestFilterMetadataRegistry(unittest.TestCase):
    ...
    def test_filter_metadata_registry(self):
        ...
        self.assertSetEqual(
            ...
            set([
                colour.luminance_ASTMD153508, colour.luminance_Newhall1943,
                colour.luminance_CIE1976, colour.luminance_Fairchild2010
            ]))
        ...
        self.assertSetEqual(
            ...
            set([
                colour.Lab_to_LCHab, colour.Lab_to_XYZ, colour.LCHab_to_Lab,
                colour.LCHuv_to_Luv, colour.lightness_CIE1976,
                colour.luminance_CIE1976, colour.Luv_to_LCHuv,
                colour.Luv_to_uv, colour.Luv_to_XYZ, colour.Luv_uv_to_xy,
                colour.XYZ_to_Lab, colour.XYZ_to_Luv
            ]))
