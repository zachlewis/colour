...
class TestSignal(unittest.TestCase):
    ...
    def test_required_methods(self):
        ...
        required_methods = ('__str__', '__repr__', '__getitem__',
                            ...
                            'fill_nan', 'uncertainty', 'to_series')
    ...
    def test_uncertainty(self):
        """
        Tests :func:`colour.continuous.signal.Signal.uncertainty` method.
        """

        self.assertAlmostEqual(self._signal.uncertainty(0.5), 0.5, places=7)

        np.testing.assert_array_almost_equal(
            self._signal.uncertainty(np.linspace(0, 9, 10) + 0.5),
