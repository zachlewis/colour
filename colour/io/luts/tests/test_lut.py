...
class TestLUT(unittest.TestCase):
    ...
    def test_arithmetical_operation(self):
        ...
        np.testing.assert_almost_equal(LUT_1.arithmetical_operation(
            10, '+', False).table,
                                       self._table_1 + 10,
                                       decimal=7)
        ...
        np.testing.assert_almost_equal((LUT_1 + 10).table,
                                       self._table_1 + 10,
                                       decimal=7)
        ...
        np.testing.assert_almost_equal(LUT_2.arithmetical_operation(
            10, '+', True).table,
                                       self._table_1 + 10,
                                       decimal=7)
    ...
    def test_linear_table(self):
        ...
        np.testing.assert_almost_equal(LUT_1.linear_table(),
                                       self._table_1,
                                       decimal=7)

        np.testing.assert_almost_equal(spow(
    ...
    def test_apply(self):
        ...
        np.testing.assert_almost_equal(LUT_1.apply(RANDOM_TRIPLETS),
                                       self._applied_1,
                                       decimal=7)
        ...
        np.testing.assert_almost_equal(LUT_2.apply(RANDOM_TRIPLETS),
                                       self._applied_2,
                                       decimal=7)
        ...
        np.testing.assert_almost_equal(LUT_3.apply(RANDOM_TRIPLETS),
                                       self._applied_3,
                                       decimal=7)
...
class TestLUTSequence(unittest.TestCase):
    ...
    def test__init__(self):
        ...
        self.assertEqual(LUTSequence(self._LUT_1, self._LUT_2, self._LUT_3),
                         self._LUT_sequence)
...
class TestLUT_to_LUT(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._LUT_2 = LUT3x1D(
            ...
            domain=self._domain)
        self._LUT_3 = LUT3D(LUT3D.linear_table(16) ** (1 / 2.2),
                            domain=self._domain)
    ...
    def test_LUT_to_LUT(self):
        ...
        self.assertEqual(
            LUT,
            LUT1D(np.sum(self._LUT_2.table * channel_weights, axis=-1),
                  domain=domain))
